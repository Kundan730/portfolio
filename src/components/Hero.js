...
import pfp from '../DSC_0454 (1)kj.JPG';
import {
  Bars3Icon,
  XMarkIcon,
  SunIcon,
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                    Myself Kundan Sahu, a 19-years-old full-stack developer,
                    plus computer vision and NLP enthusiast. From a young age, I
                    have been always passionate about technology and how it can
                    be used to solve real-world problems. I am developing my
                    skills and knowledge in the field of software development.
                  </p>
                </div>
                <div className="mt-10 flex items-center justify-center gap-x-4">
                  <a
                    href="https://www.linkedin.com/in/kundan-kumar-sahu/"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/Kundan730"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <button className="btn btn-outline btn-square">
